...
void I_Init(void)
{
...

  {
    ...
    {
#ifdef __vita__
      I_VitaTrace("I_Init: I_InitSound enter");
#endif
      I_InitSound();
#ifdef __vita__
      I_VitaTrace("I_Init: I_InitSound ready");
#endif
    }
  }

#ifdef __vita__
  I_VitaTrace("I_Init: R_InitInterpolation enter");
#endif
  R_InitInterpolation();
#ifdef __vita__
  I_VitaTrace("I_Init: leave");
#endif
}
